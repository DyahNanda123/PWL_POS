    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($kategori)
            ...
            ->addColumn('aksi', function ($kategori) { // menambahkan kolom aksi 
                ...
                $btn = '<button onclick="modalAction(\'' . url('/kategori/' . $kategori->kategori_id . '/show_ajax') . '\')" class="btn btn-info btn-sm">Detail</button> '; //menggunakan ajax
